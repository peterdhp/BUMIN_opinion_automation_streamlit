...
def multi_opinion_summary(model):
    opinion_prompt = ChatPromptTemplate.from_messages([
        ("system", """You are a doctor at a health screening center. Given multiple paragraphs containing health advice about the test results, summarize it into a more readble paragraphs. Try to output as less paragraphs as possible."""),
        ("user", """{multi_results}
