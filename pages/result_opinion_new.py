...
def multi_opinion_summary(model):
    opinion_prompt = ChatPromptTemplate.from_messages([
        ("system", """환자한테 설명하는 내용들이 여러개 있을 때 한 문단으로 자연스럽게 합쳐줘. 첫 문장은 'ㅇㅇㅇ 검사에서 ㅇㅇㅇ,ㅇㅇㅇ 및 ㅇㅇㅇ이 관찰됩니다.'으로 시작해서 설명을 덧붙이고 추적관찰, 어떤 과를 가라는 내용을 마지막에 적어줘. 되도록이면 원래 있던 내용 외에 새로운 추가하진 말아줘."""),
        ("user", """{multi_results}
