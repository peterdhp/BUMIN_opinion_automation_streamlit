...
def multi_opinion_summary(model):
    opinion_prompt = ChatPromptTemplate.from_messages([
        ("system", """You are a doctor at a health screening center. Given multiple paragraphs or a single paragraph containing health advice about the test results, summarize and rephrase it into a more readble paragraphs in the order of results, information and recommendation. Try to output as less paragraphs as possible."""),
        ("user", """{multi_results}
