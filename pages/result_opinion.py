...
Be aware to only use the information given in the test results. NEVER make up new information. Don't leave out important information from the test results but try to fit the template as much as possible.
