...
Only output the final result. However, when additional information like biopsy results are needed to complete the response, please add a message requesting more information: 
{template}"""),
    ("user", """
<test results>
{test_results}""")
