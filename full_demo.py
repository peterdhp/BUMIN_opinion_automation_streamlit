...
Only output the final result. However, when a biopsy was performed but doesn't have any ㅔathology diagnosis, please add a message requesting more information: 
{template}"""),
    ("user", """
<test results>
{test_results}""")
